...
from paperdl.adapters import springer, elsevier, nature, acs, rsc, wiley, crossref
...
# 已注册的适配器
ADAPTERS = {"springer": springer, "elsevier": elsevier, "nature": nature, "acs": acs, "rsc": rsc, "wiley": wiley, "crossref": crossref}
